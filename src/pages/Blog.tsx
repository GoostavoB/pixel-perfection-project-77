...
const blogPosts = [
  ...
  {
    slug: "medical-billing-collections",
    title: "Medical Billing Collections Explained",
    excerpt: "Learn what happens when medical bills go to collections, your FDCPA rights, and proven strategies to negotiate and settle debt.",
  ...
  },
  {
    ...
    excerpt: "Breaking down the costs of emergency care and how to identify and challenge overcharges. Real bill examples included.",
